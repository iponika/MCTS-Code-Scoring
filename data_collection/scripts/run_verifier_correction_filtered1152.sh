...
RUN_NAME="verifier_correction_filtered1152_20260420"
...
BASE_RAW="${ROOT}/model_training/review_mcts_train_data/verifier_filtered1152_baseline_raw_20260420.jsonl"
CORR_RAW="${ROOT}/model_training/review_mcts_train_data/verifier_filtered1152_correction_weak_raw_20260420.jsonl"
BASE_DATA="${ROOT}/model_training/review_mcts_train_data/verifier_filtered1152_baseline_20260420.jsonl"
CORR_DATA="${ROOT}/model_training/review_mcts_train_data/verifier_filtered1152_correction_weak_20260420.jsonl"
BASE_OUT="${ROOT}/model_training/src/output/review-lora-verifier-filtered1152-baseline-160step"
CORR_OUT="${ROOT}/model_training/src/output/review-lora-verifier-filtered1152-correction-weak-160step"
